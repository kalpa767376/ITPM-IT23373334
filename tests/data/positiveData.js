const positiveTestCases = [
  { id: 'POS_01', input: 'mage potha dhenna', expected: 'මගේ පොත දෙන්න.' },
  ...
  { id: 'POS_09', input: 'karuNaakara paQQthiya thula nishshabdha venna', expected: 'කරුණාකර පංතිය තුල නිශ්ශබ්ද වෙන්න' },
  ...
  { id: 'POS_16', input: 'heta thava siQQndhuvak kiyamu', expected: 'හෙට තව සිංන්දුවක් කියමු' },
  { id: 'POS_17', input: 'mama nivaadu gannavaa', expected: 'මම නිවාඩු ගන්නවා.' },
  { id: 'POS_18', input: 'magee CS assignment eka PDF ekak vidhiyata LMS ekata upload karanna oone', expected: 'මගේ CS assignment එක PDF එකක් විදියට LMS එකට upload කරන්න ඕනේ' },
